  ...
  return (
    <div className="min-h-[100dvh] flex items-center justify-center pt-16">
      ...
      >
        ...
        <h1 className="display-md text-void-100 mb-4">Quests</h1>
        <p className="text-void-400 text-lg mb-8">Active quests, XP progression, and achievements — coming soon.</p>
